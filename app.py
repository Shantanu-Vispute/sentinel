...
def digest_story(story_id: str):
    # Story reading is modal-only now (see /home, /digest) — this route is
    # just a stable, shareable/bookmarkable link that opens the same modal.
    return redirect(f"/home?story={story_id}")
